...
class AudioManager:
    ...
    def __init__(self, logger, config_file, display_man, sound_man):
        ...
        self.porc = pvporcupine.create(access_key="AczteRlvvZ8BZGXWcJiTkjS3hMPdgAb7JC4AenHYM2LdSdI5x/N3ag==", keywords=["computer"])
        ...
        self.l.log(f"fs value: {self.fs}", "DEBUG")
        self.l.log(f"frame_len value: {self.frame_len}", "DEBUG")
        ...
        while not self.stop_rec:
            ...
            if keyword_index >= 0:
                ...
                while True:
                    ...
                    self.l.log(f"current samps value: {self.rms(samps)}", "DEBUG")
