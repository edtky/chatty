...
def draw_active_screen(root, input_txt, response_txt, action_txt,
    ...
    if response_label is None and response_txt != "":
        response_label = scrolledtext.ScrolledText(root, wrap=tk.WORD, width=int(label_w), height=response_h, font=("Arial 25 bold"), bg=main_background_color, fg="white")
        response_label.insert(tk.INSERT, response_txt)
